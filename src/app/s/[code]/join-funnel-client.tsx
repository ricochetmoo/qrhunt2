...
function CameraAdvice({ context }: { context: ScanContext | null }) {
  ...
  if (context.inAppWebView) {
    return (
      <Message title="Use your Camera app" variant="warning">
        It looks like you scanned this with the <strong>Control Centre code scanner</strong> or an
        app&apos;s built-in scanner. That scanner forgets you every time. Close this, open the normal
        <strong> Camera app</strong>, and scan the poster again.
      </Message>
    );
  }
    ...
    <>
      ...
      {stage === "loading" ? (
        <div className="flex min-h-48 items-center justify-center">
          <Spinner label="Checking this code" size="lg" />
        </div>
      ) : null}

      {stage === "notfound" ? (
        <Message title="That code isn&apos;t part of a game" variant="danger">
          <p>Double-check you scanned a QR Hunt poster, or ask your leader for help.</p>
